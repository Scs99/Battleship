...
public class MultipleShipPlacementTest {
    ...
    public void testPlaceTwoShipsTouching() {
        ...
        // Place first ship
        game.placeShip(game.ships.get(3), 4, 4);
        game.placeShip(game.ships.get(3), 4, 5);

        // Try invalid placements for second ship
        assertFalse("Placing 3,4", game.placeShip(game.ships.get(4), 3, 4));
        assertFalse("Placing 3,5", game.placeShip(game.ships.get(4), 3, 5));
        ...
        assertFalse("Placing 4,4", game.placeShip(game.ships.get(4), 4, 4));
    ...
    public void testPlaceAllShipsValid() {
        ...
        assertTrue("Ship 0, Placing 2,7", game.placeShip(game.ships.get(0), 2, 7));
        assertTrue("Ship 0, Placing 3,7", game.placeShip(game.ships.get(0), 3, 7));
        assertTrue("Ship 0, Placing 4,7", game.placeShip(game.ships.get(0), 4, 7));
        assertTrue("Ship 0, Placing 5,7", game.placeShip(game.ships.get(0), 5, 7));

        assertTrue("Ship 1, Placing 6,2", game.placeShip(game.ships.get(1), 6, 2));
        assertTrue("Ship 1, Placing 5,2", game.placeShip(game.ships.get(1), 5, 2));
        assertTrue("Ship 1, Placing 4,2", game.placeShip(game.ships.get(1), 4, 2));

        assertTrue("Ship 2, Placing 2,4", game.placeShip(game.ships.get(2), 2, 4));
        assertTrue("Ship 2, Placing 2,5", game.placeShip(game.ships.get(2), 2, 5));

        assertTrue("Ship 4, Placing 6,4", game.placeShip(game.ships.get(4), 6, 4));
        assertTrue("Ship 4, Placing 6,5", game.placeShip(game.ships.get(4), 6, 5));
    ...
    public void testPlaceTwoShipsTouchinDiagonally() {
        ...
        // Try invalid placements for second ship
        assertFalse("Placing 3,3", game.placeShip(game.ships.get(4), 3, 3));
